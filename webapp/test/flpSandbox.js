		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#appmabetestmabetest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appmabetestmabetest-display": {
								"semanticObject": "appmabetestmabetest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=appmabetest.mabetest",
									"url": sap.ui.require.toUrl("appmabetest/mabetest")
								}
							}
						}
					}
